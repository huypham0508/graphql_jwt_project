...
let AuthResolver = (exports.AuthResolver = class AuthResolver {
  ...
  async login({ email, password }, { res }) {
    ...
    const checkPassword = await index_1.Bcrypt.comparePassword(
      password,
      hashPassword
    );
    if (!checkPassword) {
    ...
    return {
      ...
      accessToken: auth_1.Auth.createToken(
        config_1.ConfigJWT.create_token_type,
        userModel
      ),
      refreshToken:
...
__decorate(
  [
    (0, type_graphql_1.Mutation)(
      (_return) => UserMutationResponse_1.UserMutationResponse
    ),
...
__decorate(
  [
    (0, type_graphql_1.Mutation)(
      (_return) => ForgotPasswordResponse_1.ForgotPasswordResponse
    ),
...
__decorate(
  [
    ...
    __param(
      0,
      (0, type_graphql_1.Arg)("id", (_type) => type_graphql_1.ID)
    ),
    __param(1, (0, type_graphql_1.Ctx)()),
    __metadata("design:type", Function),
